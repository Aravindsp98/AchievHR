from fastapi import FastAPI, FastAPI, Request, HTTPException,Depends,APIRouter
...
# Secured endpoint 2
@user_router.get("/another-secured-endpoint/")
async def another_secure_endpoint(email: str = Depends(get_authenticated_user)):
    ...
    """
    return {
        "message": "This is another secured endpoint of user service!",
        "email": email
    }